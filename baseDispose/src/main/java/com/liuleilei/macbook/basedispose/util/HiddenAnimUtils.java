...
public class HiddenAnimUtils {
    ...
    public void toggle(){
        ...
        if (View.VISIBLE == hideView.getVisibility()) {
            ...
            openAnim(hideView,mHeight);//布局铺开
        }
    }
    ...
    public static void openAnim(View v,int height) {
    ...
    public static void closeAnimate(final View view,int closeHeight) {
        int origHeight = view.getHeight();
        ValueAnimator animator = createDropAnimator(view, origHeight, closeHeight);
        animator.addListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationEnd(Animator animation) {
//                view.setVisibility(View.GONE);
